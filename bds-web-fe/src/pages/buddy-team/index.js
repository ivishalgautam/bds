...
function BuddyTeam() {
  ...
  const GroupImages = [
    {
      value: "https://localhost:3001/public/images/1693121417928_group1.png",
      label: "group1",
      imageSrc: Group1,
    },
    {
      value: "https://localhost:3001/public/images/1693121542826_group2.png",
      label: "group2",
      imageSrc: Group2,
    },
    {
      value: "https://localhost:3001/public/images/1693121593480_group3.png",
      label: "group3",
      imageSrc: Group3,
    },
    {
      value: "https://localhost:3001/public/images/1693121646738_group4.png",
      label: "group4",
      imageSrc: Group4,
    },
    {
      value: "https://localhost:3001/public/images/1693121688138_group5.png",
      label: "group5",
      imageSrc: Group5,
    },
  ];
        ...
        <div className="grid grid-cols-4 gap-8">
          {groups?.length === 0 ? (
            ...
            groups?.map((item, index) => (
              <Link key={index} href={`/buddy-team/chat/${item.id}`}>
                <div
